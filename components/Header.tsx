  ...
  return (
    <header className="h-24 flex items-center justify-between px-6 md:px-12 z-40 bg-transparent sticky top-0">
      <div className="flex items-center gap-6">
        ...
        >
          <Menu size={22} />
          <span className="hidden sm:block text-[9px] font-black uppercase tracking-[0.2em] group-hover:text-[#FF2D55]">Painel de Trabalho</span>
        </button>
        ...
        <div className="hidden lg:flex items-center gap-3 px-6 py-3 glass-card rounded-full">
          ...
          <span className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-400">
            {syncStatus === SyncStatus.SYNCING ? 'Criptografando...' : 'Link Neural Ativo'}
          </span>
        </div>
      </div>
